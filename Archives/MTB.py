...
class Channel_Class:
    ...
    def __init__(self, idx_channel, name, list_note):
        ...
        # Internal use
        self.events = {}                        # Memorize all events framed
    ...
    def add_note_evt(self, evt, second, note, velocity):
        ...
        self.events[second] = event

        return None

    # get all note value for any frame
    def get_notes_value(self, frame):
        """
...
#   Initialize the time cumul in ticks and second for the track
    ...
    for msg in track:
        ...
        if msgtype in ('note_on', 'note_off'):
            ...
            current_second = time_map.second(time_in_ticks_cumul)
