...
def add_grid(collect, Name, x, y, z, mat, sx, sy, list_note):
    ...
    for x in range (1,127):
        ...
        b_ops.object.mode_set(mode="EDIT")
        b_ops.object.hook_add_newob()  # FAIL here !!!
        obj_empty = b_dat.objects.get("Empty")
...
class Track_Class:
    ...
    def add_evt(self, evt, frame, note, velocity):
        ...
        def BG_note_on(frame, note, velocity):
            ...
            obj.keyframe_insert('scale')
            obj.location = (63 - note) * self.BGLocCoef, self.idx * self.BGLocCoef, (velocity / 8)
...
for i, track in enumerate(mid.tracks):
    ...
    if Nb_Track != 2:
        ...
        TrackList.append(Track_Class(Nb_Track, track, track.name, "GD"))
